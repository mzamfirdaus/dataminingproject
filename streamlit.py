...
st.write('Mohamad Zamfirdaus Bin Mohd Saberi, 1181101148, 011-21595015')
st.write('Siti Aisyah Binti Zali, 1181101232, 013-854 9762')
st.write('Hadya Ayeisha Binti Marzuki, 1181101256, 011-10126568')
...
selectionq6 = st.selectbox('Select state:',['Overall','Kelantan', 'Negeri Sembilan','Pahang','Perak'])
...
st.dataframe(df_FS)
"""### What is the feature selection technique used?
...
rocDT1 = roc_line + baseline.properties(title='Random Forest ROC curve ').interactive()
...
smotedRF = roc_line + baseline.properties(title='Random Forest (SMOTED) ROC curve ').interactive()

st.altair_chart(smotedRF, use_container_width=True)
